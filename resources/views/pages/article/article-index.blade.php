...
<div class="row">
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-4">
        <a href="./app-blog-post.html" class="card style-2 mb-md-0 mb-4">
            <img src="{{ asset('main') }}/src/assets/img/grid-blog-style-2.jpeg" class="card-img-top" alt="...">
            <div class="card-body px-0 pb-0">
                <h5 class="card-title mb-3">14 Tips to improve your photography</h5>
                <div class="media mt-4 mb-0 pt-1">
                    <img src="{{ asset('main') }}/src/assets/img/profile-5.jpeg" class="card-media-image me-3" alt="">
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-4">
        <a href="./app-blog-post.html" class="card style-2 mb-md-0 mb-4">
            <img src="{{ asset('main') }}/src/assets/img/grid-blog-style-1.jpg" class="card-img-top" alt="...">
            <div class="card-body px-0 pb-0">
                <h5 class="card-title mb-3">The ideal work from home office setup</h5>
                <div class="media mt-4 mb-0 pt-1">
                    <img src="{{ asset('main') }}/src/assets/img/profile-2.jpeg" class="card-media-image me-3" alt="">
                    <div class="media-body">
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-4">
        <a href="./app-blog-post.html" class="card style-2 mb-md-0 mb-4">
            <img src="{{ asset('main') }}/src/assets/img/grid-blog-style-3.jpg" class="card-img-top" alt="...">
            <div class="card-body px-0 pb-0">
                <h5 class="card-title mb-3">Top haunted houses in Great Britain</h5>
                <div class="media mt-4 mb-0 pt-1">
                    <img src="{{ asset('main') }}/src/assets/img/profile-16.jpeg" class="card-media-image me-3" alt="">
                    <div class="media-body">
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-4">
        <a href="./app-blog-post.html" class="card style-2 mb-md-0 mb-4">
            <img src="{{ asset('main') }}/src/assets/img/list-blog-style-3.jpeg" class="card-img-top" alt="...">
            <div class="card-body px-0 pb-0">
                <h5 class="card-title mb-3">29 Most Beautiful Places in the World</h5>
                <div class="media mt-4 mb-0 pt-1">
                    <img src="{{ asset('main') }}/src/assets/img/profile-32.jpeg" class="card-media-image me-3" alt="">
                    <div class="media-body">
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-4">
        <a href="./app-blog-post.html" class="card style-2 mb-md-0 mb-4">
            <img src="{{ asset('main') }}/src/assets/img/grid-blog-style-5.jpg" class="card-img-top" alt="...">
            <div class="card-body px-0 pb-0">
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-4">
        <a href="./app-blog-post.html" class="card style-2 mb-md-0 mb-4">
            <img src="{{ asset('main') }}/src/assets/img/masonry-blog-style-3.jpeg" class="card-img-top" alt="...">
            <div class="card-body px-0 pb-0">
                <h5 class="card-title mb-3">9 Reasons why sugar is bad for your health</h5>
                <div class="media mt-4 mb-0 pt-1">
                    <img src="{{ asset('main') }}/src/assets/img/profile-19.jpeg" class="card-media-image me-3" alt="">
                    <div class="media-body">
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-4">
        <a href="./app-blog-post.html" class="card style-2 mb-md-0 mb-4">
            <img src="{{ asset('main') }}/src/assets/img/grid-blog-style-4.jpg" class="card-img-top" alt="...">
            <div class="card-body px-0 pb-0">
    ...
    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-4">
        <a href="./app-blog-post.html" class="card style-2 mb-md-0 mb-4">
            <img src="{{ asset('main') }}/src/assets/img/masonry-blog-style-4.jpeg" class="card-img-top" alt="...">
            <div class="card-body px-0 pb-0">
                <h5 class="card-title mb-3">How to plan a trip in 7 easy steps</h5>
                <div class="media mt-4 mb-0 pt-1">
                    <img src="{{ asset('main') }}/src/assets/img/profile-9.jpeg" class="card-media-image me-3" alt="">
                    <div class="media-body">
