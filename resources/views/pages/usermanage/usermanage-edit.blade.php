...
@section('content')
    ...
    <form action="{{ route('usermanage.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group mt-2 col-lg-6 col-12">
                                ...
                                <input type="text" class="form-control @error('user_placebirth') is-invalid @enderror" name="user_placebirth" value="{{ $user->user_placebirth }}">
                                @error('user_placebirth') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="form-group mt-2 col-lg-6 col-12">
                                <label for="user_datebirth">Tanggal Lahir</label>
                                <input type="date" class="form-control @error('user_datebirth') is-invalid @enderror" name="user_datebirth" value="{{ $user->user_datebirth }}">
                            ...
                            <div class="form-group mt-2 col-lg-6 col-12">
                                ...
                                <input type="text" class="form-control @error('user_idcard') is-invalid @enderror" name="user_idcard" value="{{ $user->user_idcard }}">
