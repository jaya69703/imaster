...
<div class="card-body">
    <form action="{{ route('login') }}" method="POST" role="form">
        ...
        <div class="mb-3">
          <label style="font-size: 14px" for="Password">Password</label>
        ...
        <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{ route('register') }}" class="text-dark font-weight-bolder">Sign up</a></p>
      </form>
</div>
@endsection
